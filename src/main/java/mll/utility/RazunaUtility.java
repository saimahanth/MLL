...
public static String parseRazunaResponse(String response) throws Exception {
 ...
 /* public static void main(String args[])
  {
  	try {
		System.out.println(createJsonForCustomFields(null,"12345"));
...
{
	try {
		parseRazunaResponse("<?xml version=\"1.0\" encoding=\"UTF-8\"?><Response><responsecode>0</responsecode><message>success</message><assetid>38F26EC2DBB64E77BD1D083AB7989B57</assetid><filetype>aud</filetype><comingfrom><![CDATA[]]></comingfrom><renamefilebody><![CDATA[]]></renamefilebody></Response>");
	} catch (Exception e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
